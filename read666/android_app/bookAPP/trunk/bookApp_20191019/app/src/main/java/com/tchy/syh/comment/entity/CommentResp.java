...
public class CommentResp implements Serializable {
    ...
    public static class DataBean {
        ...
        //public static class ListBean {
            ...
            public void setComment_list(List<ListBean> comment_list) {
        ...
        @Override public void writeToParcel(Parcel dest, int flags) {dest.writeString(this.id);dest.writeString(this.uid);dest.writeInt(this.puid);dest.writeString(this.learn_id);dest.writeInt(this.album_id);dest.writeString(this.content);dest.writeInt(this.reply_num);dest.writeInt(this.lovenum);dest.writeString(this.add_time);dest.writeString(this.love_id);dest.writeString(this.avatar);dest.writeString(this.nickname);dest.writeString(this.type);dest.writeInt(this.is_love);dest.writeTypedList(this.comment_list);}protected ListBean(Parcel in) {this.id = in.readString();this.uid = in.readString();this.puid = in.readInt();this.learn_id = in.readString();this.album_id = in.readInt();this.content = in.readString();this.reply_num = in.readInt();this.lovenum = in.readInt();this.add_time = in.readString();this.love_id = in.readString();this.avatar = in.readString();this.nickname = in.readString();this.type = in.readString();this.is_love = in.readInt();this.comment_list = in.createTypedArrayList(ListBean.CREATOR);}public static final Creator<ListBean> CREATOR = new Creator<ListBean>(){@Override public ListBean createFromParcel(Parcel source) {return new ListBean(source);}@Override public ListBean[] newArray(int size) {return new ListBean[size];}};}
    }
}
