package com.tchy.syh.imageview;
...
public class TouchImageView extends ImageView {
    ...
    public void setImageBitmap(Bitmap bm){  //先执行这个方法，再执行initBitmap
        ...
        int viewHeight1 = (int) (viewWidth/imgWidth*imgHeight);

        if(viewHeight!=0 && viewWidth!=0) {
            if (viewHeight1>viewHeight)
                viewHeight = viewHeight1;
            setViewSize(viewHeight,viewWidth);
            initBitmap();
        } else{
            viewWidth = getWidth();
