...
public class CommentListItemVm extends BaseViewModel{
    ...
    String id;
    public CommentListItemVm(Context context, CommentResp.DataBean.ListBean entity,int i,boolean canClickItem,boolean isLearn,String id) {
        super(context);
