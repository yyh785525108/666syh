...
public class CustomToastView extends LinearLayoutCompat {
    int paddingHor=10;
    int paddingVer=20;
    int imageid;
    int strid;
    ...
    public CustomToastView(Context context, AttributeSet set) {
        super(context,set);


    }

    public CustomToastView(Context context, int topResourceid, Spannable topSpan, int strid) {
        this(context);
